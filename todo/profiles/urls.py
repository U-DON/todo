...
urlpatterns = patterns('',
    ...
    url(r'^password_reset/$', 'django.contrib.auth.views.password_reset', {'template_name': 'profiles/password_reset.html', 'email_template_name': 'profiles/password_reset_email.html', 'post_reset_redirect': reverse_lazy('profiles:password_reset_done')}, name='password_reset'),
