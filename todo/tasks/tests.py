...
class TaskManagerTest(TestCase):
    ...
    def test_reminder_in_current_query_set(self):
    ...
    def test_routine_in_current_query_set(self):
    ...
    @patch('tasks.models.schedule_archival')
    def test_reminder_in_done_query_set(self, mock_schedule_archival):
    ...
    @patch('tasks.models.schedule_archival')
    def test_routine_in_done_query_set(self, mock_schedule_archival):
    ...
    @patch('tasks.models.schedule_archival')
    def test_reminder_and_routine_in_done_query_set(self, mock_schedule_archival):
    ...
    @patch('tasks.models.schedule_archival')
    def test_reminder_in_done_query_set_before_and_after_archival(self, mock_schedule_archival):
    ...
    @patch('tasks.models.schedule_archival')
    def test_routine_not_in_done_query_set_after_archival(self, mock_schedule_archival):
    ...
    @patch('tasks.models.schedule_archival')
    def test_reminder_not_in_later_query_set_before_or_after_archival(self, mock_schedule_archival):
    ...
    @patch('tasks.models.schedule_archival')
    def test_routine_in_later_query_set_after_archival(self, mock_schedule_archival):
